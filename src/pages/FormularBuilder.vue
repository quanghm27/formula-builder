<template>
  <div class="w-1/2 mx-auto">
    <div class="mb-2 text-center text-3xl text-teal-700">Formular Builder</div>
    <div class="bg-gray-200 py-4 px-2 shadow-lg border overflow-x-auto">
      <Operator ref="rootNode" :operator="formular[0]" />
      <span
        ...
        >Add Something...</span
      >
      <formula-inline :formula="formular[0]" />
      <div v-if="existFormular" class="flex-col mt-8">
        <!--        <div class="mb-8">-->
        <!--          <Hint-->
        ...
        <div class="flex gap-2">
          <span
            ...
            >View result</span
          >
          <p class="py-1 text-gray-700 font-bold">{{ result }}</p>
        </div>
      </div>
    </div>
  </div>
...
import FormulaInline from "../components/formula/FormulaInline.vue";

export default {
  name: "FormularBuilder",
  components: { Operator, FormulaInline },
  filters: {
